...
# SW Greenland, Iceland, Spitbergen
# 
...
m.point <- 0.69 * m.adj # Smith and Gaston (2012)
...
# harvest statistics for Greeland
...
#to look at the aportionment of harvest

(total_harvest%*%t(regional_vul))*2

#to look at the aportionment of harvest - Greenland
...
# now some juvenile ratio data for Greenland
...
#set-up starting population vector
...
# no need for heroics here, work done by Morten, and inputted directly from Appendix F
...
# TBMU - for oiling is driver by the same vulnerabilities as the hunt
